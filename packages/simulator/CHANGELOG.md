...
- `CreateLiveContextOptions.additionalCoinEncPublicKeyMappings` maps coin public keys to encryption public keys for every live call, so a circuit can send a shielded coin to a wallet other than the caller
