...
All notable changes to `@openzeppelin/compact-tools-simulator` will be documented in this file.
...
- Initial public release of `@openzeppelin/compact-tools-simulator`.
