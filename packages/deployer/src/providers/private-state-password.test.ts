...
describe('derivePrivateStatePassword', () => {
  ...
  it('never contains 4 identical chars in a row', () => {
    for (let i = 0; i < 200; i++) {
  ...
  it('produces a password with mixed character classes (uppercase + digit + symbol)', () => {
  ...
  it('handles inputs that would have produced naïve-bad passwords', () => {
