/** Programmatic API for `@openzeppelin/compact-deployer`; `compact-deploy` is an opinionated shell over this. */
...
export type {
  CompactContractClass,
  ConstructorArgsOf,
  RunDeployOptions,
} from './runDeploy.ts';
export { constructorArgs, runDeploy } from './runDeploy.ts';
